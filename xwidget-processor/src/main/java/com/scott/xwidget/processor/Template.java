...
class Template {
    ...
    static {
        ...
        template.append("import com.scott.xwidget.drawable.ShadowGradientDrawable;\n");
        ...
        template.append("                drb = parseGradientDrawable(new ShadowGradientDrawable(), arr);\n");
        ...
        template.append("        }\n");
        template.append("\n");
        template.append("        if (gradientDrawable instanceof ShadowGradientDrawable) {\n");
        template.append("            ShadowGradientDrawable shadowDrawable = (ShadowGradientDrawable) gradientDrawable;\n");
        template.append("\n");
        ...
        template.append("            float shadowDy = arr.getDimension(R.styleable.XTextViewCustom_XTextViewCustom_stated_shadow_dy, 0f);\n");
        template.append("            float shadowRadius = arr.getDimension(R.styleable.XTextViewCustom_XTextViewCustom_stated_shadow_radius, 0f);\n");
        template.append("            shadowDrawable.setShadowColor(shadowColor);\n");
        template.append("            shadowDrawable.setCorner(statedCorner);\n");
        template.append("            shadowDrawable.setShadowDx(shadowDx);\n");
        template.append("            shadowDrawable.setShadowDy(shadowDy);\n");
        template.append("            shadowDrawable.setShadowR((int) shadowRadius);\n");
        template.append("            shadowDrawable.setCorerType(stateCornerType);\n");
        template.append("        }\n");
        template.append("\n");
        ...
        template.append("        GradientDrawable normaDrawable = buildNormalGradientDrawable(new ShadowGradientDrawable(), arr);\n");
        ...
        template.append("        }\n");
        template.append("\n");
        template.append("        GradientDrawable statedDrawable = buildStatedGradientDrawable(buildNormalGradientDrawable(new ShadowGradientDrawable(), arr), arr);\n");
