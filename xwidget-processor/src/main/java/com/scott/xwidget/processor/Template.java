...
class Template {
    ...
    static {
        ...
        template.append("        }\n");
        template.append("\n");
        template.append("        boolean rippleEnable = arr.getBoolean(R.styleable.XTextViewCustom_XTextViewCustom_ripple_enable, false);\n");
        template.append("        int rippleColor = arr.getColor(R.styleable.XTextViewCustom_XTextViewCustom_ripple_color, 0);\n");
        template.append("\n");
        ...
        template.append("                return new RippleDrawable(ColorStateList.valueOf(rippleColor), new GradientDrawableDecorator(mNormal), null);\n");
        ...
        template.append("            return new StateListDrawableDecorator(type, normalDrawable, stateDrawable);\n");
        template.append("        } else {\n");
        template.append("            return new RippleDrawable(ColorStateList.valueOf(rippleColor), new StateListDrawableDecorator(type, normalDrawable, stateDrawable), null);\n");
        template.append("        }\n");
        template.append("    }\n");
        template.append("\n");
