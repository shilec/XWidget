...
class Template {
    ...
    static {
        ...
        template.append("\n");
        template.append("        drawableInfo.shapedLeftEdgeType = arr.getInt(R.styleable.XViewTemplate_XViewTemplate_shaped_leftEdgeType, 0);\n");
        template.append("        drawableInfo.shapedLeftEdgeSize = arr.getDimension(R.styleable.XViewTemplate_XViewTemplate_shaped_leftEdgeSize, 0);\n");
        template.append("\n");
        template.append("        drawableInfo.shapedRightEdgeType = arr.getInt(R.styleable.XViewTemplate_XViewTemplate_shaped_rightEdgeType, 0);\n");
        template.append("        drawableInfo.shapedRightEdgeSize = arr.getDimension(R.styleable.XViewTemplate_XViewTemplate_shaped_rightEdgeSize, 0);\n");
        template.append("\n");
        template.append("        drawableInfo.shapedTopEdgeType = arr.getInt(R.styleable.XViewTemplate_XViewTemplate_shaped_topEdgeType, 0);\n");
        template.append("        drawableInfo.shapedTopEdgeSize = arr.getDimension(R.styleable.XViewTemplate_XViewTemplate_shaped_topEdgeSize, 0);\n");
        template.append("\n");
        template.append("        drawableInfo.shapedBottomEdgeType = arr.getInt(R.styleable.XViewTemplate_XViewTemplate_shaped_bottomEdgeType, 0);\n");
        template.append("        drawableInfo.shapedBottomEdgeSize = arr.getDimension(R.styleable.XViewTemplate_XViewTemplate_shaped_bottomEdgeSize, 0);\n");
